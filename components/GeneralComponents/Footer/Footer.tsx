...
const SERVICE_LINKS = [
  ...
  { href: '/services/septic-install',    label: 'New Septic Install' },
  { href: '/services/aerobic-systems',   label: 'Aerobic Systems' },
  { href: '/services/septic-repair',     label: 'Septic Repair' },
  { href: '/services/drain-field',       label: 'Drain Field Repair' },
  { href: '/services/inspections',       label: 'Inspections & Maintenance' },
];
...
const TRUST_ITEMS = [
  ...
  { icon: faWrench,       label: 'TCEQ-Licensed' },
  { icon: faClock,        label: 'Same-Day Service' },
  { icon: faBolt,         label: 'Clean Job Guarantee' },
];

const SOCIALS = [
  { href: 'https://facebook.com/clearflowseptic', icon: faFacebookF, label: 'Facebook' },
  { href: 'https://g.page/r/clearflowseptic',     icon: faGoogle,    label: 'Google' },
];
          ...
          <div className={styles.brandCol}>
            <Link href="/" className={styles.logo}>
              ...
              <div className={styles.logoText}>
                <span className={styles.logoName}>ClearFlow Septic</span>
                <span className={styles.logoSub}>Waco, Texas</span>
              </div>
            </Link>

            <p className={styles.tagline}>
              Flat-rate pricing. Same-day service. Zero contracts — ever. Serving Central Texas homes and businesses since 2004.
            </p>

            <div className={styles.contactBlock}>
              <a href="tel:+12548707070" className={styles.phoneLink}
                onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Footer Phone', section: 'Footer-Brand' })}>
                <FontAwesomeIcon icon={faPhone} />
                (254) 870-7070
              </a>
              <a href="mailto:hello@clearflowseptic.com" className={styles.emailLink}
                onClick={() => trackEvent({ eventType: 'email_click', elementLabel: 'Footer Email', section: 'Footer-Brand' })}>
                <FontAwesomeIcon icon={faEnvelope} />
                hello@clearflowseptic.com
              </a>
      ...
      <div className={styles.bottomBar}>
        <div className={styles.bottomInner}>
          <p className={styles.copyright}>
            &copy; {new Date().getFullYear()} ClearFlow Septic. All Rights Reserved. | TCEQ-Licensed Installers · Bonded & Insured
          </p>
          <a href="tel:+12548707070" className={styles.emergencyBtn}
