  ...
  return (
    <section className={styles.heroSection}>
      ...
      <div className={styles.heroContainer}>
        ...
        >
          <span className={styles.eyebrow}>Since 2004 · {cityName}, TX</span>
          <h1 className={styles.heroTitle}>
            Central Texas septic<br />
            <em>Done Right.</em><br />
            Every Time.
          </h1>
          <p className={styles.heroSubtitle}>
            ClearFlow Septic has been keeping homes and businesses comfortable in{' '}
          ...
          <div className={styles.imageFrame}>
            <div className={styles.imageWrapper}>
              <Image
                ...
                alt="ClearFlow Septic — Waco, Texas septic technicians"
                fill
            ...
            <div className={styles.trustCard}>
              ...
              <div className={styles.trustCardText}>
                <span className={styles.trustCardTitle}>ClearFlow Septic</span>
                <span className={styles.trustCardSub}>Waco's Most Trusted septic</span>
              </div>
            </div>
          </div>
        </motion.div>
