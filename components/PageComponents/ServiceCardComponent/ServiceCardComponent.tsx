...
export default function ServiceCardComponent({
  cards,
  heading    = 'Everything Your Septic System Needs',
  subheading = 'From emergency pump-outs to new installs and aerobic systems, ClearFlow Septic handles it all — on time, on price.',
