...
const DEFAULT_ROWS: ComparisonRow[] = [
  ...
  { feature: 'Clean Job Guarantee',                    us: true,  others: false },
  { feature: 'Emergency pump-out available',           us: true,  others: 'Sometimes' },
  { feature: 'TCEQ-licensed installers',               us: true,  others: 'Sometimes' },
  { feature: 'Licensed & insured technicians',         us: true,  others: true },
  { feature: 'Upfront quote before work begins',       us: true,  others: false },
  { feature: 'Conventional & aerobic systems',         us: true,  others: 'Sometimes' },
...
export default function ValueComparison({ rows = DEFAULT_ROWS, title = 'ClearFlow Septic vs. The Other Guys' }: ValueComparisonProps) {
  return (
