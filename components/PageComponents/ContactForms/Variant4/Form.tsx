...
const SERVICES = [
  { icon: faWrench,        label: 'Septic Repair',  sub: 'Off-track, rollers, noisy door' },
  ...
  { icon: faBuilding,      label: 'Aerobic Systems',    sub: 'Rolling steel & high-cycle' },
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successState}
                  ...
                  <p className={styles.successText}>
                    A licensed ClearFlow Septic tech will reach out about your <strong>{selectedService}</strong> service.
                  </p>
