...
const SERVICES = [
  { icon: faWrench,          label: 'Septic Repair' },
  ...
  { icon: faBuilding,        label: 'Aerobic Systems' },
...
const TRUST_CHIPS = [
  ...
  { icon: faStar,         text: '4.9★ · 1,100+ reviews' },
];
            ...
            {submitted ? (
              <motion.div key="success" className={styles.successState}
                ...
                <p className={styles.successText}>
                  A licensed ClearFlow Septic technician will reach out shortly. Keep an eye on your inbox and phone.
                </p>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  ...
                  <div className={styles.submitRow}>
                    ...
                    <div className={styles.altContact}>
                      ...
                      <span>Need help now?{' '}
                        <a href="tel:+12548707070"
                          onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Call (254) 870-7070', section: 'ContactForm-V1' })}>
                          Call (254) 870-7070
                        </a>
                      </span>
                    </div>
