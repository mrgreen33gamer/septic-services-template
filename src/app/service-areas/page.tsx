...
// ClearFlow Septic — Service Areas Page
'use client';
...
const SERVICE_AREAS = [
  {
    ...
    badge:       'Home Base',
    description: 'Our headquarters. Fastest response times, same-day service available 7 days a week. Full septic repair, spring & cable repair, track and hardware, lighting, inspections, and commercial doors across all of Waco.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       'Primary Area',
    description: 'Full septic coverage for Hewitt homes and businesses. Fast dispatch from our Waco base — typically under 45 minutes.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       'Primary Area',
    description: "Serving Woodway's residential neighborhoods with the same flat-rate pricing and Clean Job Guarantee as every other area we cover.",
    highlights:  ['Flat-rate pricing', 'Clean Job Guarantee', 'TCEQ-licensed'],
  },
  {
    city:        'Bellmead',
    slug:        'bellmead-tx',
    county:      'McLennan County',
    badge:       '',
    description: 'Reliable septic service for Bellmead residents and businesses. System upgrades, repairs, and lighting installs — same-day when available.',
    highlights:  ['Residential & commercial', 'TCEQ-licensed septic technicians', 'No contracts'],
  },
  {
    city:        'China Spring',
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Rural and residential septic service for the China Spring area. We make the drive — flat-rate pricing applies just the same.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Septic repair, spring & cable repair, and shop power for McGregor homes and light industrial properties.',
  ...
  },
  {
    ...
    county:      'Bell County',
    badge:       '',
    description: 'Septic repair, installation, and upgrades for Killeen and Fort Cavazos area homes and businesses. Military-friendly scheduling.',
  ...
  },
  {
    ...
    county:      'Bell County',
    badge:       '',
    description: 'Full-service septic coverage for Temple. Medical district and surrounding neighborhoods served. Full residential and commercial septic.',
...
const faq = [
  ...
  {
    question: 'Do you work on commercial septic in all areas?',
    answer: 'Yes — light commercial septic for restaurants, offices, retail spaces, and small warehouses is within scope across all our coverage areas. Call to discuss your specific project and location.',
  },
  {
    ...
    <main className={styles.page}>
        ...
        <div className={styles.heroInner}>
          ...
          >
            <div className={styles.heroBadge}>
              ...
              Central Texas Septic — Since 2004
            </div>
            ...
            <p className={styles.heroSub}>
              Based in Waco, serving all of Central Texas. Flat-rate pricing, TCEQ-licensed septic technicians, and a Clean Job Guarantee — no matter where you are.
            </p>
            <div className={styles.heroActions}>
              <a href="tel:+12548707070" className={styles.heroCTAPrimary}>
        ...
        <div className={styles.areasSectionInner}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionSub}>
              Click any city to see local service details, common septic issues in your area, and what to expect from our team.
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className={styles.areaFooter}>
                    <a href="tel:+12548707070" className={styles.areaCallBtn}>
      ...
      <section className={styles.unlisted}>
        <div className={styles.unlistedInner}>
          ...
          <a href="tel:+12548707070" className={styles.unlistedCTA}>
            Call (254) 870-7070
          </a>
        </div>
      </section>
      ...
      <CTABanner
        ...
        subline="Same-day service available across Central Texas. Flat-rate pricing, Clean Job Guarantee, no contracts ever."
