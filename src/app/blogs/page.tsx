    ...
    <main className={styles.page}>
      ...
      <section className={styles.pageHeader}>
        ...
        >
          ...
          <h1 className={styles.pageTitle}>ClearFlow Septic — Blog Center</h1>
          <p className={styles.pageSubtitle}>
            Practical septic safety tips, spring & cable repair guidance, and door maintenance advice for Central Texas homeowners.
          </p>
        </motion.div>
      </section>
        ...
        <div className={styles.container}>
          ...
          >
            <p className={styles.blogCTAHeading}>
              Need a licensed septic technician in Central Texas?
            </p>
            <p className={styles.blogCTABody}>
              We&apos;ve been powering Waco-area homes and businesses with expert septic repair, spring & cable repair, and installations since 2004. Free estimate, no obligations.
            </p>
