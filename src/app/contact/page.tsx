...
// ClearFlow Septic — Contact Page (unique build, not just a form import)
...
// ── Service options ────────────────────────────────────────────────────────────
const SERVICES = [
  'Septic Pumping', 'New Septic Install', 'Aerobic Systems',
  'Septic Repair', 'Drain Field Repair', 'Inspections & Maintenance',
  'Emergency Pump-Out', 'Other / Not Sure',
];
...
const faq = [
  {
    ...
    answer: "Call us directly at (254) 870-7070. We answer 7 days a week including evenings. For a genuine septic emergency in Central Texas, call — don't wait on a form response.",
  },
  {
  ...
  {
    question: 'Do you work on commercial septic systems?',
    answer: 'Yes — light commercial septic for restaurants, offices, retail spaces, and small warehouses is within our scope. Call to discuss your specific system and location.',
  },
  {
  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroInner}>
          ...
          <motion.h1 className={styles.heroTitle}
            ...
            Let&apos;s Get Your<br />
            <span className={styles.heroAccent}>System Flowing</span>
          </motion.h1>
        ...
        <div className={styles.mainInner}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.infoCards}>
              {[
                ...
                },
                {
                  ...
                  label:     'Email',
                  value:     'hello@clearflowseptic.com',
                  href:      'mailto:hello@clearflowseptic.com',
                ...
                },
                {
                  ...
                  label:     'Address',
                  value:     '1900 S University Parks Dr, Waco TX 76706',
            ...
            <div className={styles.trustBlock}>
              <p className={styles.trustHeading}>Why homeowners choose ClearFlow Septic</p>
              {[
                'Flat-rate pricing — written quote before we start',
                '1-year parts & labor warranty on every repair',
                'TCEQ-licensed technicians only',
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successCard}
                  ...
                  <p className={styles.successText}>
                    A licensed ClearFlow Septic septic technician will reach out shortly — usually within one business day. For urgent needs, call us at{' '}
                    <a href="tel:+12548707070">(254) 870-7070</a>.
                  </p>
      ...
      <CTABanner
        ...
        subline="Call (254) 870-7070 — we answer 7 days a week, evenings included. Emergency service available across Central Texas."
        primaryText="Call (254) 870-7070"
        primaryLink="tel:+12548707070"
        secondaryText="Send a Text"
        secondaryLink="sms:+12548707070"
      />
